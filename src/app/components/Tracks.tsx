    ...
    return(
        <main className="w-full h">
            ...
            <div className="flex w-10/12 lg:w-[1040px] flex-col items-center justify-between mx-auto mb-20 mt-5 lg:flex-row">
                <div className="flex flex-col w-full mb-5 lg:mb-0 lg:w-[40%] mx-auto lg:ml-0 mt-3 px-5 pt-4 pb-6 rounded-md border border-white  hover:bg-slate-900">
                ...
                <div className="flex flex-col w-full lg:w-[40%] mx-auto lg:mr-0 mt-3 px-5 pt-4 pb-6 rounded-md border border-white  hover:bg-slate-900">
